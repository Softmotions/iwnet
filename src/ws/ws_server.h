...
struct iwn_ws_handler_spec {
  iwn_ws_msg_handler   msg_handler; ///< Websocket messages handler. Required.
  void *msg_handler_user_data;      ///< Message handler user data.
...
IW_EXPORT void iwn_ws_server_route_attach(struct iwn_wf_route *route, const struct iwn_ws_handler_spec *spec);
